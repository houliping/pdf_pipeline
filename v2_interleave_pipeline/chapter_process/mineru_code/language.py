...
print("fast_langdetect path:", fast_langdetect.__file__)

if not os.getenv("FTLANG_CACHE"):
    current_file_path = os.path.abspath(__file__)
    current_dir = os.path.dirname(current_file_path)
    # root_dir = os.path.dirname(current_dir)
    ftlang_cache_dir = os.path.join(current_dir, 'resources', 'fasttext-langdetect')
...
if __name__ == '__main__':
    ...
    print(detect_lang("〖\ud835\udc46\ud835〗这是个包含utf-16的中文测试This is a testThis is a test"))